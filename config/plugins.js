module.exports = ({ env }) => ({
  ...
  'strapi-cache': {
    ...
    config: {
      ...
      cacheableRoutes: ['/api/courses', '/api/exercises', '/api/lessons', '/api/lesson-pages', '/api/texts', '/api/text-words'], // Caches routes which start with these paths (if empty array, all '/api' routes are cached)
